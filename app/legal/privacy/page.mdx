...
At {siteConfig.author.name} ("we", "us", or "our"), your privacy is important to us. This Privacy Policy outlines our practices regarding the collection, use, and disclosure of your personal information when you use {siteConfig.name} (the "Service"). By using our Service, you agree to the collection and use of information in accordance with this Privacy Policy.
...
- To protect and defend the rights or property of {siteConfig.author.name}
